...
from algorithms.quick_sort_random import quick_sort as quick_sort_random
...
def test_execution_time(algorithm, test_set):
    ...
    print('{} took {} milliseconds'.format(algorithm, run_time))
...
def start_tests(n):
    ...
    for algorithm in algorithms:
        for test_set in test_sets:
            try:
                test_execution_time(algorithm, test_sets[test_set])
